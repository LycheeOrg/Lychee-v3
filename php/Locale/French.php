...
final class French
{
    ...
    static public function get_locale()
    {
        $locale	= array(
            ...
            'ALBUM_BASICS'				=> 'Information de base',
            'ALBUM_TITLE'				=> 'Titre',
            ...
            'PHOTO_BASICS'				=> 'Information de base',
            'PHOTO_TITLE'				=> 'Titre',
            ...
            'ERROR_DB_1'				=> 'Connexion impossible à la base de données car l\'accès a été refusé. Vérifiez votre nom d\'utilisateur et mot de passe, et assurez-vous que l\'accès est autorisé a partir de votre emplacement actuel.',
            'ERROR_DB_2'				=> 'Impossible de creer la base de données. Verifiez votre nom d\'utilisateur et mot de passe, et assurez-vous que l\'utilisateur specifié est autorisé à modifier et ajouter le contenu dans la base de données.',
            'ERROR_CONFIG_FILE'			=> "Impossible d\'enregistrer cette configuration. Pérmission refusée dans <b>'data/'</b>. Veuillez paramétrer les droits de lecture, d\'ecriture et d\'exécution pour les autres utilisateurs dans <b>'data/'</b> et <b>'uploads/'</b>. Consultez le fichier Readme pour obtenir plus d\'information.",
            'ERROR_UNKNOWN'				=> 'Une erreur inattendue est survenue. Veuillez réessayer et vérifier votre inscription et votre serveur. Consultez le fichier Readme pour obtenir plus d\'information.',
            'ERROR_LOGIN'				=> 'Impossible d\'enregistrer l\'information de connexion. Veuillez réessayer avec un autre nom d\'utilisateur et mot de passe.',
            'RETRY'						=> 'Réessayer',
            ...
            'LOGIN_TITLE'				=> 'Entrez un nom d\'utilisateur et un mot de passe pour votre inscription:',
            'LOGIN_USERNAME' 			=> 'Nouvel utilisateur',
            'LOGIN_PASSWORD' 			=> 'Mot de passe nouveau',
            'LOGIN_CREATE'				=> 'Créer l\'information de connexion',

            'PASSWORD_TITLE'			=> 'Entrez votre mot de passe existant:',
            'PASSWORD_CURRENT'			=> 'Mot de passe existant',
            'PASSWORD_TEXT'				=> 'Votre nom d\'utilisateur et votre mot de passe seront modifiés comme suivi :',
            'PASSWORD_CHANGE'			=> 'Modifier l\'information de connexion',

            'EDIT_SHARING_TITLE'		=> 'Modifier le partage',
            'EDIT_SHARING_TEXT'			=> 'Les propriétés de partage de cet album vont etre modifiées comme suivi :',
            'SHARE_ALBUM_TEXT'			=> 'Cet album sera partagé avec les propriétés suivantes:',

            'SORT_ALBUM_BY_1'			=> 'Triér les albums',
            ...
            'SORT_PHOTO_SELECT_1'		=> 'Heure de chargement',
            ...
            'DROPBOX_TEXT'				=> "Pour pouvoir importer des photos à partir de votre Dropbox, vous aurez besoin d\'une clé d\'application \"drop-ins\" validé à creer sur <a href='https://www.dropbox.com/developers/apps/create'>leur site</a>. Générez votre clé personnelle et puis entrez-la ci-dessous:",
            ...
            'UPLOAD_MANAGE_NEW_PHOTOS'	=> 'Vous pouvez désormais gérer vos photos nouvelles.',
            'UPLOAD_COMPLETE'			=> 'Chargement terminé',
            'UPLOAD_COMPLETE_FAILED'	=> 'Le chargement d\'une ou de plusieurs photos a echoué.',
            'UPLOAD_IMPORTING'			=> 'Importation',
            'UPLOAD_IMPORTING_URL'		=> 'Importation depuis l\'URL',
            'UPLOAD_UPLOADING'			=> 'Chargement en cours',
            'UPLOAD_FINISHED'			=> 'Terminé',
            'UPLOAD_PROCESSING'			=> 'Traitement',
            'UPLOAD_FAILED'				=> 'Echec',
            'UPLOAD_FAILED_ERROR'		=> 'Echec du chargement. Le serveur a rendu une erreur !',
            'UPLOAD_FAILED_WARNING'		=> 'Echec du chargement. Le serveur a rendu un avertissement !',
            'UPLOAD_SKIPPED'			=> 'Ignoré',
            'UPLOAD_ERROR_CONSOLE'		=> 'Veuillez consulter la console de votre navigateur pour obtenir plus de détails.',
            'UPLOAD_UNKNOWN'			=> 'Le serveur a rendu une reponse inconnue. Veuillez consulter la console de votre navigateur pour obtenir plus de détails.',
            'UPLOAD_ERROR_UNKNOWN'		=> 'Echec du chargement. Le serveur a rendu une erreur inconnue !',
            'UPLOAD_IN_PROGRESS'		=> 'Lychee est en cours de chargement !',
            'UPLOAD_IMPORT_WARN_ERR'	=> 'L\'importation est terminée, mais les erreurs ou les avertissements ont été rendus. Veuillez consulter le fichier de Log (Parametres -> Afficher les logs) pour obtenir plus de détails.',
            'UPLOAD_IMPORT_COMPLETE'	=> 'Importation terminée',
            'UPLOAD_IMPORT_INSTR'		=> 'Veuillez entrer un lien direct vers la photo pour l\'importer :',
