...
final class French
{
    ...
    static public function get_locale()
    {
        $locale	= array(
            ...
            'SORT_PHOTO_SELECT_1'		=> 'Heure de upload',
            ...
            'DROPBOX_TEXT'				=> "Pour pouvoir importer des photos a partir de votre Dropbox, vous aurez besoin d\'une cle d\'application \"drop-ins\" valide a creer sur <a href='https://www.dropbox.com/developers/apps/create'>leur site</a>. Générez votre cle personnelle puis entrez-la ci-dessous:",
            ...
            'UPLOAD_MANAGE_NEW_PHOTOS'	=> 'Vous pouvez desormais gérer vos nouvelles photos.',
            ...
            'UPLOAD_UPLOADING'			=> 'En upload',
            'UPLOAD_FINISHED'			=> 'Termine',
            'UPLOAD_PROCESSING'			=> 'Traitement',
            'UPLOAD_FAILED'				=> 'Echec',
            'UPLOAD_FAILED_ERROR'		=> 'Echec de l\'upload. Le serveur a retourné une erreur !',
            'UPLOAD_FAILED_WARNING'		=> 'Echec de l\'upload. Le serveur a retourné un avertissement !',
            'UPLOAD_SKIPPED'			=> 'Ignore',
            'UPLOAD_ERROR_CONSOLE'		=> 'Veuillez consulter la console de votre navigateur pour obtenir plus de details.',
            'UPLOAD_UNKNOWN'			=> 'Le serveur a retourné une reponse inconnue. Veuillez consulter la console de votre navigateur pour obtenir plus de details.',
            ...
            'UPLOAD_IMPORT_WARN_ERR'	=> 'L\'importation est terminée, mais des erreurs ou des avertissements ont ete retournés. Veuillez consulter le fichier de Log (Parametres -> Afficher les logs) pour obtenir plus de détails.',
            ...
            'UPLOAD_IMPORT_SERVER_EMPT'	=> 'Impossible de demarrer l\'importation car le dossier était vide !'
        );
